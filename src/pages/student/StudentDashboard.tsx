...
import { FileText, Plus, Eye, Clock, CheckCircle, XCircle, Upload } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage your train concession applications</p>
      </div>
            ...
            <div className="divide-y divide-gray-200">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500">
                        {app.year} {app.branch} • {new Date(app.created_at).toLocaleDateString()}
                      </p>
                    </div>
              ...
              {applications.length === 0 && (
                <div className="px-6 py-8 text-center text-gray-500">
                  No applications yet. Click "Apply" to submit your first concession request.
                </div>
              )}
            </div>
          </div>
      ...
      {activeTab === 'apply' && (
        <ConcessionForm onSuccess={fetchApplications} />
      )}
