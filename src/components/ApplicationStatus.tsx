    ...
    return (
      <div className="bg-white rounded-xl shadow-md p-8 text-center">
        ...
        <p className="text-gray-600">
          You haven't submitted any concession applications yet. Click "Apply"
      ...
      <div className="bg-white rounded-xl shadow-md">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">
            Track all your concession applications
          </p>
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                    ...
                    <div className="text-sm text-gray-600">
                      <span>
                        {application.class_type} • {application.pass_type}
                      </span>
                    </div>
                  </div>
                  ...
                  {application.is_expired && (
                    <div className="mt-4 p-3 bg-red-50 rounded-lg">
                      <p className="text-sm text-red-700">
                        Your concession has expired. Please renew to continue
                        benefits.
                      </p>
                      <button
                        onClick={() => {
                          ...
                          url.searchParams.set("renewId", application.id);
              ...
              {application.status === "approved" && (
                <div className="mt-4 p-3 bg-green-50 rounded-lg">
                  <p className="text-sm text-green-800">
                    Congratulations! Your concession application has been
                    approved. You can collect your concession form from the
                    office.
                  </p>
                </div>
              )}
              ...
              {application.status === "rejected" && (
                <div className="mt-4 p-3 bg-red-50 rounded-lg">
                  <p className="text-sm text-red-800">
                    ...
                    office for more details or submit a new application with
                    correct information.
                  </p>
                </div>
              )}
